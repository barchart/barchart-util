...
public class TestPriceArrayMap {
	...
	public void testPut() {
		...
		final PriceValue p1 = newPrice(123, -2); // 1.23
		...
		final PriceValue p2 = newPrice(128, -2); // 1.28
		...
		final PriceValue p3 = newPrice(12, -1); // 1.20
		...
		final PriceValue p4 = newPrice(1211, -3); // 1.21

		assertNull(map.get(p4));

		//

		final PriceValue p5 = newPrice(123123, -5); // 1.23
