...
public class TestDefTextLong {
	...
	public void testLongConstructor() {
		...
		long value = 65 << 0 + 66 << 8;

		TextValue text = new DefTextLong(value);

		int size = JavaSize.of(text);
	...
	public void testCharAt() {
		...
		long value = (0x41 << 0 * 8) + (0x42 << 1 * 8) + (0x43 << 2 * 8);
	...
	public void testSubString() {
		...
		CharSequence seq3 = text0.subSequence(3, 4);
	...
	public void testArrayConstructor() {
		...
		byte[] array = new byte[] { 'A', 'B', 'C' };

		// System.err.println("value=" + Long.toHexString(value));

		TextValue text = new DefTextLong(array);
	...
	public void testStringConstructor() {
		...
		TextValue text = new DefTextLong(string);
		...
		assertEquals(new DefTextLong("01234567").hashCode(), "01234567"
				.hashCode());
	...
	public void testToUpperCase() {
		...
		TextValue text1 = new DefTextLong("aBcD1?xY");
		TextValue text2 = text1.toUpperCase();
