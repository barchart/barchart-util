...
public final class JavaSize {
	...
	private static final Logger log = LoggerFactory.getLogger(JavaSize.class);
	...
	private static final Deque<Object> stack = new LinkedBlockingDeque<Object>();

	public synchronized static final int of(final Object object) {
